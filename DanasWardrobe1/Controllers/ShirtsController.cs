...
namespace DanasWardrobe1.Controllers
{
    public class ShirtsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShirtID,Name,Photo,Type,Color,Season,Occasion")] Shirt shirt)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShirtID,Name,Photo,Type,Color,Season,Occasion")] Shirt shirt)
        {
            if (ModelState.IsValid)
            {
